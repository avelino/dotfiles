...
brew "d12frosted/emacs-plus/emacs-plus@28", args: ["with-modern-doom3-icon", "with-native-comp", "with-no-titlebar-and-round-corners"]
...
vscode "bbrakenhoff.solarized-light-custom"
