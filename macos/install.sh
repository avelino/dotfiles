...
# Backup being done with `defaults export`, in my configuration vi `brew bkp`
# bkp: defaults export NSGlobalDomain ~/dotfiles/macos/nsglobaldomain.plist
defaults import NSGlobalDomain ~/dotfiles/macos/nsglobaldomain.plist
...
# Set highlight color to bleu (default color)
...
#defaults write NSGlobalDomain AppleLocale -string "en_BR@currency=USD"
...
defaults write com.apple.screencapture location ~/Google\ Drive/My\ Drive/Screenshots/
